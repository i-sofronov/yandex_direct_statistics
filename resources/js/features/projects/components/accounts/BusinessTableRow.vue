...
const tooltipId = computed(() => {
    return 'business-table-row-tooltip-' + props.id
})
...
<template>
    <ModuleTableRow>
        ...
        <ModuleTableCell cell-width="100">
            <TableIndicator
                :indicator="total?.feedbacks"
                :dynamic="total.dynamic.feedbacks"
            ></TableIndicator>
        </ModuleTableCell>

        <ModuleTableCell cell-width="100">
            <TableIndicator
                :indicator="total.rating"
                :dynamic="total.dynamic.rating"
            ></TableIndicator>
        </ModuleTableCell>

        <ModuleTableCell cell-width="95">
            <TableIndicator
                :indicator="total.calls_clicks"
                :dynamic="total.dynamic.calls_clicks"
            ></TableIndicator>
        </ModuleTableCell>

        <ModuleTableCell cell-width="195">
            <TableIndicator
                :indicator="total.routes_clicks"
                :dynamic="total.dynamic.routes_clicks"
            ></TableIndicator>
        </ModuleTableCell>

        <ModuleTableCell cell-width="145">
            <TableIndicator
                :indicator="total.action_clicks"
                :dynamic="total.dynamic.action_clicks"
            ></TableIndicator>
        </ModuleTableCell>
